          ...
          foreach ($foodie_restaurant_archive_element_sortable as $key => $value) {
            if($value === 'option1') { ?>
              <div class="post-meta my-3">
                ...
                <span class="ms-3"><i class="far fa-comments me-2"></i> <?php comments_number(esc_attr('0', 'foodie-restaurant'), esc_attr('0', 'foodie-restaurant'), esc_attr('%', 'foodie-restaurant')); ?> <?php esc_html_e('comments', 'foodie-restaurant'); ?></span>
              </div>
            <?php }
            if($value === 'option2') { ?>
